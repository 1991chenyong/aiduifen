...
class TestUser:
    ...
    @pytest.mark.parametrize('testcases_info', read_testcase_yaml('testcases/userManage/userManage.yaml'))
    ...
    @pytest.mark.parametrize('testcases_info', read_testcase_yaml('testcases/userManage/userManage_export.yaml'))
    ...
    @allure.story("单个发放ADFun接口跳过")
    @pytest.mark.parametrize('testcases_info', read_testcase_yaml('testcases/userManage/userManage_giveadf.yaml'))
    ...
    @pytest.mark.parametrize('testcases_info', read_testcase_yaml('testcases/userManage/userManage_load_adf.yaml'))
